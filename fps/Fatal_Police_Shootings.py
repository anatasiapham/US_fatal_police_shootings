...
st.markdown('Using public data collected by the Washington Post, I wanted to visualize and learn about the victims of fatal police shootings in the United States. The entire project can be found by visiting the following **[Github]()**.')
